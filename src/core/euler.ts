 ...
 * @returns The output Euler.
 */
export function fromRotationMat4(out: Euler, rotationMatrix: Const<Mat4>, order: EulerOrder = out[3] || 'xyz'): Euler {
 ...
 */
export function exactEquals(a: Const<Euler>, b: Const<Euler>): boolean {
 ...
 * @returns True if the euler angles are equal, false otherwise.
 */
export function equals(a: Const<Euler>, b: Const<Euler>): boolean {
    const a0 = a[0];
    const a1 = a[1];
    const a2 = a[2];
    const b0 = b[0];
 ...
 * @returns The output Euler
 */
export function fromQuat(out: Euler, q: Const<Quat>, order: EulerOrder): Euler {
 ...
 * @returns The output Euler.
 */
export function reorder(out: Euler, a: Const<Euler>, order: EulerOrder): Euler {
