 ...
 */
function setUnitAxis(out: Vec3, axis: Const<Vec3>): Vec3 {
 ...
 */
export function addBone(chain: Chain3, start: Const<Vec3>, end: Const<Vec3>, joint: Joint3 = createJoint3()): Bone3 {
    const bone: Bone3 = {
 ...
 * @returns the appended bone
 */
export function addConsecutiveBone(chain: Chain3, direction: Const<Vec3>, length: number, joint: Joint3 = createJoint3()): Bone3 {
 ...
 */
export function addBoneAtBase(chain: Chain3, direction: Const<Vec3>, length: number, joint: Joint3 = createJoint3()): Bone3 {
...
export function setHingeJoint(
    ...
    rotationAxis: Const<Vec3>,
    clockwise: number,
    anticlockwise: number,
    referenceAxis: Const<Vec3>,
): Joint3 {
    joint.type = type;
 ...
 */
export function setBaseLocation(chain: Chain3, base: Const<Vec3>): Chain3 {
    chain.base[0] = base[0];
    chain.base[1] = base[1];
    chain.base[2] = base[2];
    return chain;
 ...
 */
export function straighten(chain: Chain3, direction: Const<Vec3>): Chain3 {
 ...
 */
export function getBoneRotation(out: Quat, chain: Chain3, index: number, up: Const<Vec3>): Quat {
...
export function isReachable(chain: Chain3, target: Const<Vec3>): boolean {
 ...
 * @returns the chain
 */
export function forward(chain: Chain3, target: Const<Vec3>): Chain3 {
    const bones = chain.bones;
 ...
 * @returns the chain
 */
export function backward(chain: Chain3, base: Const<Vec3>): Chain3 {
    const bones = chain.bones;
    const count = bones.length;
 ...
 */
export function iterate(chain: Chain3, target: Const<Vec3>): number {
 ...
 */
export function solve(chain: Chain3, target: Const<Vec3>): number {
    const count = chain.bones.length;
 ...
 */
export function solveStructure(structure: Structure3, target: Const<Vec3>): void {
...
function orthonormalize(out: Vec3, a: Const<Vec3>, axis: Const<Vec3>): Vec3 {
...
function normalizeOr(out: Vec3, fallback: Const<Vec3>): Vec3 {
    if (!hasDirection(vec3.squaredLength(out))) {
 ...
 */
function projectOntoHinge(out: Vec3, x: number, y: number, z: number, axis: Const<Vec3>, referenceAxis: Const<Vec3>): Vec3 {
...
function rotateAboutAxis(out: Vec3, a: Const<Vec3>, axis: Const<Vec3>, radians: number): Vec3 {
    const ax = a[0];
    const ay = a[1];
    const az = a[2];
    const kx = axis[0];
 ...
 */
function basisFromDirection(out: Mat3, direction: Const<Vec3>): Mat3 {
    const x = direction[0];
    const y = direction[1];
    const z = direction[2];
