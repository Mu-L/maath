 ...
 */
export function clone(box: Const<Box3>): Box3 {
 ...
 */
export function copy(out: Box3, box: Const<Box3>): Box3 {
    out[0] = box[0];
    out[1] = box[1];
    out[2] = box[2];
    out[3] = box[3];
 ...
 * @returns The updated Box3
 */
export function setFromVectors(out: Box3, min: Const<Vec3>, max: Const<Vec3>): Box3 {
    out[0] = min[0];
    out[1] = min[1];
    out[2] = min[2];
    out[3] = max[0];
 ...
 */
export function min(out: Vec3, box: Const<Box3>): Vec3 {
    out[0] = box[0];
    out[1] = box[1];
    out[2] = box[2];
    return out;
 ...
 */
export function max(out: Vec3, box: Const<Box3>): Vec3 {
    out[0] = box[3];
    out[1] = box[4];
    out[2] = box[5];
    return out;
 ...
 */
export function exactEquals(a: Const<Box3>, b: Const<Box3>): boolean {
 ...
 * @returns True if the boxes are equal, false otherwise
 */
export function equals(a: Const<Box3>, b: Const<Box3>): boolean {
    const a0 = a[0];
    const a1 = a[1];
    const a2 = a[2];
    const a3 = a[3];
 ...
 * @returns The updated Box3
 */
export function setFromCenterAndSize(out: Box3, center: Const<Vec3>, size: Const<Vec3>): Box3 {
    const hx = size[0] * 0.5;
    const hy = size[1] * 0.5;
    const hz = size[2] * 0.5;
    out[0] = center[0] - hx;
 ...
 */
export function expandByPoint(out: Box3, box: Const<Box3>, point: Const<Vec3>): Box3 {
 ...
 * @returns The expanded Box3
 */
export function expandByExtents(out: Box3, box: Const<Box3>, vector: Const<Vec3>): Box3 {
 ...
 * @returns The expanded Box3
 */
export function expandByMargin(out: Box3, box: Const<Box3>, margin: number): Box3 {
    out[0] = box[0] - margin;
    out[1] = box[1] - margin;
    out[2] = box[2] - margin;
    out[3] = box[3] + margin;
 ...
 */
export function union(out: Box3, boxA: Const<Box3>, boxB: Const<Box3>): Box3 {
 ...
 */
export function center(out: Vec3, box: Const<Box3>): Vec3 {
 ...
 */
export function extents(out: Vec3, box: Const<Box3>): Vec3 {
 ...
 */
export function size(out: Vec3, box: Const<Box3>): Vec3 {
    out[0] = box[3] - box[0];
    out[1] = box[4] - box[1];
    out[2] = box[5] - box[2];
    return out;
 ...
 */
export function surfaceArea(box: Const<Box3>): number {
 ...
 */
export function scale(out: Box3, box: Const<Box3>, scale: Const<Vec3>): Box3 {
 ...
 */
export function transformMat4(out: Box3, box: Const<Box3>, mat: Const<Mat4>): Box3 {
    const bMinX = box[0];
    const bMinY = box[1];
    const bMinZ = box[2];
    const bMaxX = box[3];
 ...
 */
export function containsPoint(box: Const<Box3>, point: Const<Vec3>): boolean {
    return (
        point[0] >= box[0] &&
        point[0] <= box[3] &&
        point[1] >= box[1] &&
 ...
 */
export function containsBox3(container: Const<Box3>, contained: Const<Box3>): boolean {
    return (
 ...
 */
export function intersectsBox3(boxA: Const<Box3>, boxB: Const<Box3>): boolean {
    return (
        boxA[0] <= boxB[3] &&
        boxA[3] >= boxB[0] &&
        boxA[1] <= boxB[4] &&
 ...
 */
export function intersectsTriangle3(box: Const<Box3>, a: Const<Vec3>, b: Const<Vec3>, c: Const<Vec3>): boolean {
 ...
 */
export function intersectsSphere(box: Const<Box3>, sphere: Const<Sphere>): boolean {
 ...
 */
export function intersectsPlane3(box: Const<Box3>, plane: Const<Plane3>): boolean {
