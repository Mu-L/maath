 ...
 */
export function fromNormalAndConstant(out: Plane3, normal: Const<Vec3>, constant: number): Plane3 {
 ...
 * @returns The output plane
 */
export function fromNormalAndPoint(out: Plane3, normal: Const<Vec3>, point: Const<Vec3>): Plane3 {
    vec3.copy(out.normal, normal);
 ...
 * @returns The output plane
 */
export function fromCoplanarPoints(out: Plane3, a: Const<Vec3>, b: Const<Vec3>, c: Const<Vec3>): Plane3 {
    const ax = a[0];
    const ay = a[1];
    const az = a[2];
 ...
 * @returns A new plane
 */
export function clone(plane: Const<Plane3>): Plane3 {
    return {
 ...
 * @returns The output plane
 */
export function copy(out: Plane3, plane: Const<Plane3>): Plane3 {
 ...
 */
export function normalize(out: Plane3, plane: Const<Plane3>): Plane3 {
 ...
 */
export function negate(out: Plane3, plane: Const<Plane3>): Plane3 {
 ...
 */
export function offset(out: Plane3, plane: Const<Plane3>, distance: number): Plane3 {
    vec3.copy(out.normal, plane.normal);
 ...
 */
export function distanceToPoint(plane: Const<Plane3>, point: Const<Vec3>): number {
 ...
 */
export function projectPoint(out: Vec3, plane: Const<Plane3>, point: Const<Vec3>): Vec3 {
 ...
 */
export function transform(out: Plane3, plane: Const<Plane3>, matrix: Const<Mat4>): Plane3 {
 ...
 */
export function intersectsSphere(plane: Const<Plane3>, sphere: Const<Sphere>): boolean {
 ...
 */
export function exactEquals(a: Const<Plane3>, b: Const<Plane3>): boolean {
 ...
 */
export function intersect(out: Vec3, p1: Const<Plane3>, p2: Const<Plane3>, p3: Const<Plane3>): boolean {
 ...
 */
export function equals(a: Const<Plane3>, b: Const<Plane3>): boolean {
