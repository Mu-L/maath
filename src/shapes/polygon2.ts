 ...
 */
export function containsPoint(vertices: readonly number[], n: number, point: Const<Vec2>): boolean {
    let inside = false;
    const x = point[0];
    const y = point[1];
 ...
 * @returns out
 */
export function closestPoint(out: Vec2, vertices: readonly number[], n: number, point: Const<Vec2>): Vec2 {
    const px = point[0];
    const py = point[1];
 ...
 */
export function signedDistance(vertices: readonly number[], n: number, point: Const<Vec2>): number {
    const px = point[0];
    const py = point[1];
    let bestDistSq = Number.POSITIVE_INFINITY;
 ...
 */
export function intersectsSegment(vertices: readonly number[], n: number, a: Const<Vec2>, b: Const<Vec2>): boolean {
