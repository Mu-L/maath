 ...
 */
export function bounds(out: Box3, a: Const<Vec3>, b: Const<Vec3>, c: Const<Vec3>): Box3 {
 ...
 */
export function normal(out: Vec3, a: Const<Vec3>, b: Const<Vec3>, c: Const<Vec3>): Vec3 {
    const abx = b[0] - a[0];
    const aby = b[1] - a[1];
    const abz = b[2] - a[2];
 ...
 */
export function centroid(out: Vec3, a: Const<Vec3>, b: Const<Vec3>, c: Const<Vec3>): Vec3 {
    out[0] = (a[0] + b[0] + c[0]) / 3;
    out[1] = (a[1] + b[1] + c[1]) / 3;
    out[2] = (a[2] + b[2] + c[2]) / 3;
