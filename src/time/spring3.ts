...
export const create = (value: Const<Vec3> = [0, 0, 0]): Spring<Vec3> => ({
...
export function damp(state: Spring<Vec3>, target: Const<Vec3>, smoothTime: number, delta: number): Spring<Vec3> {
