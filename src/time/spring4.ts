...
export const create = (value: Const<Vec4> = [0, 0, 0, 0]): Spring<Vec4> => ({
...
export function damp(state: Spring<Vec4>, target: Const<Vec4>, smoothTime: number, delta: number): Spring<Vec4> {
